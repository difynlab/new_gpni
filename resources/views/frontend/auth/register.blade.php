    ...
    <div class="row flex-grow-1 d-flex align-items-center">
            ...
            <div class="col-lg-8 white-section d-flex justify-content-center">
                <div class="form-container">
                    <h1 class="fs-39 text-center pt-4">Register now and get started!</h1>
                    <p class="subheading fs-16 text-center">Enter your details below to kickstart your journey.
