            ...
            <div class="form-container">
                ...
                <form method="POST" action="{{ route('frontend.login.store') }}">
                    ...
                    <div class="form-group">
                        ...
                        <input type="email" class="form-control fs-13" id="username" name="email"
                    ...
                    <div class="form-group position-relative">
                        ...
                        <input type="password" class="form-control pr-5 fs-13" id="password" name="password"
                    ...
                    <div class="remember-forget">
                        <div class="form-check">
                            ...
                            <label class="form-check-label fs-13" for="remember-password"
                                style="font-size:13px; font-weight:400;">Remember password</label>
                        </div>

                        <a href="{{ route('frontend.password.request') }}" class="text-primary"
                            style="font-size:13px; font-weight:400;">Forget Password?</a>
                    </div>
