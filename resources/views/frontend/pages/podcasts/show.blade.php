...
<div class="full-page-layout">
    ...
    <section class="cta-section">
        <div class="container">
            <h1 class="mb-4 fs-49">{{ $contents->{'section_3_title_' . $middleware_language} ??
                $contents->section_3_title_en
                }}</h1>
            ...
            <div class="pt-3 d-flex justify-content-center align-items-center flex-wrap cta-buttons">
                <a href="{{ json_decode($contents->{'section_3_labels_links_' . $middleware_language})[0]->link ?? json_decode($contents->section_3_labels_links_en)[0]->link }}"
                    class="btn-register fs-20">{{ json_decode($contents->{'section_3_labels_links_' .
                    $middleware_language})[0]->label ?? json_decode($contents->section_3_labels_links_en)[0]->label
                    }}</a>
