                    ...
                    <div class="col-6">
                        ...
                        <div class="card payment-methods">
                            ...
                            <div class="payment-icons">
                                <img src="{{ asset('storage/frontend/products/visa-logo-png-2026-1.svg') }}" alt="Visa">
                                <img src="{{ asset('storage/frontend/products/mastercard.svg') }}" alt="MasterCard">
                                <img src="{{ asset('storage/frontend/products/amex.svg') }}" alt="American Express">
                                <img src="{{ asset('storage/frontend/products/discover.svg') }}" alt="Discover">
                            </div>
                        </div>
                    </div>
                </div>
