...
@push('after-styles')
    <link rel="stylesheet" href="{{ asset('frontend/css/certification-courses.css') }}">
@endpush
    ...
    <div class="container my-5">
                ...
                <div class="row">
                    ...
                    <div class="col-12 col-md-6 d-flex align-items-center justify-content-center">
                        <div class="text-section">
                            ...
                            <p>{{  $course->certification_section_2_description }}</p>
            ...
            <div class="row content-wrapper">
                ...
                <div class="col-12 col-md-6 testimonial-content">
                    <div class="testimonial-stars">
                        ...
                        {{  $course->certification_section_5_rating }}
                    </div>
                    <div class="testimonial-text">
                    {{  $course->certification_section_5_content }}
                    </div>
                    <div class="testimonial-author">
                        <div class="name">
                        {{  $course->certification_section_5_name }}
                        </div>
                        <div class="role">
                        {{  $course->certification_section_5_designation }}
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-12 col-lg-6">
                        ...
                        <p class="program-description">{{  $course->certification_section_6_description }}</p>
        ...
        <section class="cissn-section container">
            <div class="row align-items-start">
                <div class="col-lg-6">
                    {!!  $course -> certification_section_10_content !!}
                </div>
                <div class="col-lg-6">
        ...
        @php
            $advisoryBoardLink = json_decode($course->certification_section_12_label_link);
        @endphp
        ...
        @php
            $tablePoints = json_decode($course->certification_section_13_table_points);
            $paymentLinks = json_decode($course->certification_section_13_labels_links);
        @endphp
        <section class="payment-options-section container">
            ...
            <p class="payment-options-description">
                {{  $course -> certification_section_13_description }}
            </p>
        ...
        <section class="masters-pack-section">
            ...
            <div class="masters-pack-content">
                <h2 class="masters-pack-title">{{ $course -> certification_section_16_title }}
                </h2>
                {!!  $course -> certification_section_16_content !!}
