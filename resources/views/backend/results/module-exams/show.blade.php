    ...
    <div class="static-pages">
        <div class="exam-header">
            <div class="exam-title-section">
                ...
                <p class="exam-details">{{ $course->title }} | {{ $course_module->title }}</p>
            </div>
            
            <div class="exam-result">
                <div class="result-item">
                    <p class="result-heading">Total Question</p>
                    <p class="result-value">{{ $course_module_exam->total_questions }}</p>
                </div>

                <div class="result-item">
                    <p class="result-heading">Total Correct Answers</p>
                    <p class="result-value">{{ $course_module_exam->total_correct_answers }}</p>
                </div>

                <div class="result-item">
                    <p class="result-heading">Total un attended  Answers</p>
                    <p class="result-value">{{ $course_module_exam->total_un_attended_answers }}</p>
                </div>

                <div class="result-item">
                    <p class="result-heading">Marks(%)</p>
                    <p class="result-value">{{ $course_module_exam->marks }}</p>
                </div>
