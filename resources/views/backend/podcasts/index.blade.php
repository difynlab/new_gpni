...
@section('content')
    ...
    <x-backend.breadcrumb page_name="Podcasts"></x-backend.breadcrumb>

    <div class="pages">
        <div class="row mb-4">
            <div class="col-12 text-end">
                <a href="{{ route('backend.podcasts.create') }}" class="add-button">
        ...
        <div class="row mb-4">
            <div class="col-12">
                <form action="{{ route('backend.podcasts.filter') }}" method="GET" class="filter-form">
        ...
        <x-backend.delete-data title="Podcast"></x-backend.delete-data>
    </div>
    ...
    <script>
        $(document).ready(function() {
            $('.pages .table .delete-button').on('click', function() {
                let id = $(this).attr('id');
                let url = "{{ route('backend.podcasts.destroy', [':id']) }}";
            ...
            $(".pages .pagination-form select").change(function () {
                window.location = "{!! $podcasts->url(1) !!}&items=" + this.value; 
            });
        });
    </script>
@endpush