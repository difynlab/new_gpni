            ...
            <div class="section">
                ...
                <div class="row form-input">
                    <div class="col-12">
                        ...
                        <div>
                            <x-backend.upload-multi-images image_count="2" old_name="old_certificate_images" old_value="{{ old('old_certificate_images', $course->certificate_images) }}" new_name="new_certificate_images[]" path="courses/certificate-images"></x-backend.upload-multi-images>
